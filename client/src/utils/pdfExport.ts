...
export const generatePDF = async (posts: Post[], options: { includeComments?: boolean; includeTags?: boolean; user?: { username?: string; email?: string } } = {}) => {
  const doc = new jsPDF();
  ...
  doc.text(`Generated by: ${generatedBy} at ${new Date().toLocaleTimeString()}`, 190, 45, { align: 'right' });
...
export const downloadPDF = async (posts: Post[], filename?: string, options?: { includeComments?: boolean; includeTags?: boolean; user?: { username?: string; email?: string } }) => {
